...
SECRET_KEY = 'django-insecure-l0i%g3d$#i!9i-1+#7hbm$_(((4y!ldigav^7ce7zbq93ybx4k'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'coffeeshop' / 'db.sqlite3',
    }
}
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'coffeeshop' / 'static']
...
# Media files
MEDIA_ROOT = BASE_DIR / 'coffeeshop' / 'media'
MEDIA_URL = '/media/'
