...
class TestOrderCreateForm:
    ...
    def test_form_with_user(self, test_user: User) -> None:
        ...
        form_data = {"delivery_address": "123 Main Street, Apt 4B", "phone": "+79001234567"}
    ...
    def test_invalid_phone_format(self, test_user: User, invalid_phone: str) -> None:
        ...
        form_data = {"delivery_address": "123 Main Street, Apt 4B", "phone": invalid_phone}
    ...
    def test_valid_form_data(self, test_user: User) -> None:
        ...
        form_data = {"delivery_address": "123 Main Street, Apt 4B, City, 123456", "phone": "+79001234567"}
    ...
    def test_form_phone_validator(self, test_user: User) -> None:
        ...
        valid_phones = ["+79001234567", "+7 900 123 45 67", "79001234567", "+12345678901"]

        for phone in valid_phones:
            form_data = {"delivery_address": "123 Main Street, Apt 4B", "phone": phone}
            form = OrderCreateForm(data=form_data, user=test_user)
    ...
    def test_form_delivery_address_validator(self, test_user: User) -> None:
        ...
        for address in valid_addresses:
            form_data = {"delivery_address": address, "phone": "+79001234567"}
            form = OrderCreateForm(data=form_data, user=test_user)
    ...
    def test_form_error_handling(self, test_user: User) -> None:
        ...
        form_data = {"delivery_address": "Short", "phone": "invalid"}
