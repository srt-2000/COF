...
class TestOrderService:
    ...
    def test_create_order(
        self, mocker, test_user: User, mock_cart_for_order, mock_form_data, mock_applied_promo_id
    ) -> None:
        ...
        mock_promo_context.return_value = {"applied_promo_name": "TEST10", "applied_promo_status": True}
        ...
        result = service.create_order(
            user=test_user, cart=mock_cart_for_order, form_data=mock_form_data, applied_promo_id=mock_applied_promo_id
        )
...
class TestDatabaseOrderRepository:
    ...
    def test_save_order(self, test_user: User, order_item_data: dict[str, str | int | Decimal]) -> None:
    ...
    def test_save_order_with_multiple_items(
        self, mocker, test_user: User, order_item_data: dict[str, str | int | Decimal]
    ) -> None:
...
class TestEmailOrderNotification:
    ...
    def test_send_order_notification(self, mocker, test_user: User) -> None:
    ...
    def test_send_order_notification_error(self, mocker, test_user: User) -> None:
...
class TestOrderServiceIntegration:
    ...
    def test_order_with_multiple_items(
        ...
        mock_repository.save_order.return_value = {
            ...
            "time_created": "2024-03-20 12:00:00",
            "items": [
                {"product_id": 1, "product_name": "Product 1", "quantity": 2, "price": Decimal("100.00")},
                {"product_id": 2, "product_name": "Product 2", "quantity": 1, "price": Decimal("150.00")},
            ],
            "applied_promo_name": "TEST10",
            "applied_promo_status": True,
        }
